...
- **Analyze what you gather** with the Mode 1 extraction framework in the main skill instructions (jobs to be done, pains, triggers, outcomes, language, alternatives) and the confidence guardrails.
